...
<div class="nav nav-links" id="nav-tab" role="tablist">
	...
	<button class="nav-link" id="nav-options-tab" data-bs-toggle="tab" data-bs-target="#options" type="button" role="tab" aria-controls="nav-options" aria-selected="false">Options</button>
