...
$show_pricing           = isset( $atts['show_pricing'] ) ? 'show_pricing="' . ( filter_var( $atts['show_pricing'], FILTER_VALIDATE_BOOLEAN ) ? 'true' : 'false' ) . '"' : '';
...
<div id="tg-shop" class="tapgoods tapgoods-inventory container-fluid">
    <?php if ( false !== $show_search ) : ?>
        ...
        <?php echo do_shortcode( '[tapgoods-search nos="true" category="' . esc_attr($category) . '" tags="' . esc_attr($tags) . '" per_page_default="' . esc_attr($per_page_default) . '"]' ); ?>
