...
$location_id = tg_get_wp_location_id(); // Change this function depending on how you get the location ID
...
$args = array(
    ...
    'meta_query'     => array(
        array(
            'key'     => 'tg_locationId', // Make sure this meta key is correct
            'value'   => $location_id,
            'compare' => '=', // Only show items that match the location ID
        ),
    ),
);
