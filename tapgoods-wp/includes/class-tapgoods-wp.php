...
class Tapgoods {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_tg_api_sync', $this->plugin_admin, 'tg_api_sync', 10, 1 );
		$this->loader->add_action( 'wp_ajax_nopriv_tg_api_sync', $this->plugin_admin, 'tg_api_sync', 10, 1 );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'body_class', $plugin_public, 'tg_add_body_classes', 10, 1 );
		...
		$this->loader->add_filter( 'render_block', $this, 'tg_disable_autop_blocks', 10, 2 );
	}
	...
	private function define_general_hooks() {
		...
		$this->loader->add_filter( 'cron_schedules', $this, 'tapgoods_add_cron_interval', 10, 1 );
		$this->loader->add_action( 'tapgoods_cron_hook', $this, 'tapgoods_cron_exec' );
		$this->loader->add_action( 'init', $this, 'tapgoods_cron_setup', 10, 0 );

	}

	public function tapgoods_add_cron_interval( $schedules ) {
	...
	public function tapgoods_cron_setup() {
	...
	public function tapgoods_cron_exec() {
		...
		if ( '1' === get_option( 'tg_api_connected', 0 ) ) {
			...
			$sync       = $connection->tg_async_sync_from_api();
		}
	}

	public function tg_disable_autop_blocks( $block_content, $block ) {
