...
function tg_seconds_to_string( $seconds ) {
	...
	$hour_seconds = $seconds % $seconds_per_day;
	$hours        = floor( $hour_seconds / $seconds_per_hour );

	$minute_seconds = $hour_seconds % $seconds_per_hour;
	$minutes        = floor( $minute_seconds / $seconds_per_minute );

	$remainder_seconds = $minute_seconds % $seconds_per_minute;
	$seconds           = ceil( $remainder_seconds );
